# Claude-skills-research v3.0 -- Unified MCP Skill
...
| Task | Command |
|------|---------|
| **Research** | `/unified-mcp-skill-new "Research the GitHub MCP server"` |
| **Document** | `/unified-mcp-skill-new "Document this MCP: https://github.com/org/repo"` |
| **Setup** | `/unified-mcp-skill-new "Set up the Slack MCP server locally"` |
| **Fix Errors** | `/unified-mcp-skill-new "The MCP server won't connect"` |
| **Audit** | `/unified-mcp-skill-new "Review the project"` |
| **Batch** | `/unified-mcp-skill-new "Research these MCPs: GitHub, Slack, Linear"` |
...
Claude-skills-research/
  ...
  skills/
    ...
    unified-mcp-skill-new/               # THE SKILL
...
User Input
  |
  v
/unified-mcp-skill-new (Unified Skill)
  |
...
| `skills/unified-mcp-skill-new/SKILL.md` | Complete skill definition (source of truth) |
| `skills/unified-mcp-skill-new/references/learned-fixes.md` | Error case studies |
| `skills/unified-mcp-skill-new/references/multi-server.md` | Batch research workflow |
| `skills/unified-mcp-skill-new/references/csv-example.md` | CSV formatting reference |
