...
**Post-research quality gate:** Audit CSV reports produced by `/unified-mcp-skill-new`
...
This validator is a **post-research quality gate**. It runs AFTER `/unified-mcp-skill-new`
produces a CSV, BEFORE the report is considered final.

**Recommended workflow:**
```
1. /unified-mcp-skill-new "Research server X"   -> produces CSV
